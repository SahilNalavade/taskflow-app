  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          'from': { 
            'box-shadow': '0 0 5px theme("colors.indigo.400"), 0 0 10px theme("colors.indigo.400"), 0 0 15px theme("colors.indigo.400")'
          },
          'to': { 
            'box-shadow': '0 0 10px theme("colors.indigo.400"), 0 0 20px theme("colors.indigo.400"), 0 0 30px theme("colors.indigo.400")'
          }
        }
      },
      backgroundImage: {
